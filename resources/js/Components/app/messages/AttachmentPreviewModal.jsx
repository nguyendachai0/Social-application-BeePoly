    ...
    return (
        <Transition  show={show} as={Fragment} leave="duration-200">
            ...
            onClose =  {close}>
                ...
                >
                    <Dialog.Panel className="flex  flex-col w=full h-full  transform  overflow-hidden  bg-slate-800 text-left-align-middle  shadow-xl  transtion-all">
                        <button 
                        onClick={close}
                        ...
                        <div className="relative group h-full">
                            {currentIndex > 0 &&  (
                                <div  
                                onClick={prev}
                                className="absolute opacity-100  text-gray-100  cursor-pinter flex items-center justify-center w-16 h-16 left-4  top-1/2 -translate-y-1/2 rounded-full bg-black/50 z-30"
                                >
                            ...
                            {attachment && (
                                <div className="flex items-center justify-center  w-full h-full p-3">
                                    ...
                                    {isAudio(attachment) &&  (
                                        <div className="relative flex justif-center items-center"><audio  
                                        src={attachment.url}
                                        controls
                                        autoPlay></audio></div>
                                    )}
