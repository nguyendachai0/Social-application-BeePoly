...
export default function UserOptionsDropDown({ conversation }) {
    ...
    return (
        <div>
            ...
            <Transition as={Fragment} enter="transtion ease-out duration-100" enterFrom="transform opacity-0 scale-95" enterTo="transform opacity-100 scale-100" leave="transition ease-in duration-75" leaveFrom="transform oopacity-100 scale-100"
