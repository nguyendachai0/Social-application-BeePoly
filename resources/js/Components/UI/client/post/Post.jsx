...
import { FaHeart, FaComment, FaShare, FaFlag, FaEllipsisH, FaEdit, FaTrash, FaChevronLeft, FaChevronRight, FaGlobe, FaUserFriends, FaLock } from "react-icons/fa";
      ...
      <div className="p-4 mb-5">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="ml-3">
              <div className="flex items-center space-x-2">
                ...
                {post.visibility === "public" && <FaGlobe className="text-gray-500" />}
                {post.visibility === "friends" && <FaUserFriends className="text-gray-500" />}
                {post.visibility === "private" && <FaLock className="text-gray-500" />}
              </div>
              ...
              {post.tagged_users && post.tagged_users.length > 0 && (
                <p className="text-sm text-gray-600 mt-1">
                  ...
                  {post.tagged_users.map((friend, index) => (
                    <span key={friend.id}>
                      <Link href={`${friend.email}`} className="text-blue-500 hover:underline cursor-pointer">
        ...
        <div className="flex items-center justify-between">
          <div className="flex space-x-4">
            ...
            <button
              onClick={toggleLike}
              className={`flex items-center space-x-1 transition duration-300 ${isLiked ? 'text-red-500 hover:text-red-600' : 'text-gray-500 hover:text-gray-600'
                }`}>
              <FaHeart />
              <span>{likes}</span>
            </button>
