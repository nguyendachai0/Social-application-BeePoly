...
const ChatLayout = ({ conversation, newMessage = null, onClose = () => { }, onHide = () => { }, isHidden }) => {
  ...
  return (
    ...
    <div className="fixed bottom-4 right-4 w-[20rem] md:w-[24rem] bg-white/95 backdrop-blur-lg rounded-lg shadow-2xl z-50 border border-purple-200">
      ...
      <div ref={messagesCtrRef} className="h-[18rem] lg:h-96 overflow-y-auto p-4 space-y-4">
